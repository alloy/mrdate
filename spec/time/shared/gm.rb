describe :time_gm, :shared => true do
  ruby_version_is ""..."1.9" do
    it "creates a time based on given values, interpreted as UTC (GMT)" do
      MRTime.send(@method, 2000,"jan",1,20,15,1).inspect.should == "Sat Jan 01 20:15:01 UTC 2000"
    end
  ...
  ruby_version_is "1.9" do
    it "creates a time based on given values, interpreted as UTC (GMT)" do
      MRTime.send(@method, 2000,"jan",1,20,15,1).inspect.should == "2000-01-01 20:15:01 UTC"
    end
